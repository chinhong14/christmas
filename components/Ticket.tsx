...
const Ticket: React.FC<TicketProps> = ({ name }) => {
  ...
  // We use this ref for the HIDDEN capture element
  ...
  return (
    <div className="flex flex-col items-center gap-4 md:gap-8 animate-fade-in-up w-full max-w-[90vw] md:max-w-6xl px-0 md:px-0 pb-12">
      ...
      {/* =======================
          ...
          Opacity set to 1, but positioned far off-screen to be hidden from user
          while visible to html2canvas.
         ======================= */}
      <div 
        ref={captureRef}
        style={{
             ...
             background: '#020617',
             zIndex: -100,
             opacity: 1 // Crucial for html2canvas
        }}
        className="bg-slate-950"
      >
        <div 
            className={`
                relative bg-slate-950 border-2 border-gold-500 overflow-hidden flex-shrink-0
                flex-grow rounded-l-3xl border-r-0 pr-8 min-h-[380px]
                p-12 flex flex-col justify-between text-left
            `}
        >
             <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_-20%,rgba(234,179,8,0.15),transparent_70%)] pointer-events-none"></div>
             <div className="absolute top-8 right-8 pointer-events-none">
                 <div className="w-24 h-24 border-t-2 border-r-2 border-gold-400 rounded-tr-3xl relative">
            ...
            <div className="relative z-10 flex flex-col h-full text-left">
                <div className="mb-10">
                    <h2 className="font-script text-5xl text-gold-400 mb-2 transform -rotate-2 origin-bottom-left drop-shadow-md">
                        Kundasang Gang
                    </h2>
                    {/* Solid Gold Text for Capture */}
                    <h1 className="font-serif text-6xl text-gold-400 drop-shadow-sm uppercase tracking-wide">
                        Christmas Party
                    </h1>
                </div>
                <div className="flex flex-col items-start mb-auto w-full max-w-md">
                     <p className="text-[10px] text-gold-500/80 uppercase tracking-[0.2em] font-bold mb-2">Guest Name</p>
                     <div className="font-serif text-6xl text-white tracking-wide mb-2 break-words w-full leading-tight">
                        {name || "Guest"}
                     </div>
                     <div className="w-full h-[1px] bg-gradient-to-r from-gold-500 to-transparent mb-4"></div>
                     <p className="text-gold-400 font-sans text-[11px] tracking-[0.4em] uppercase font-bold">
                        Premium Invite
                     </p>
                </div>
                <div className="flex justify-between items-end mt-8">
                    <div className="grid grid-cols-2 gap-16 text-sm font-sans w-full max-w-lg">
                        <div className="text-left">
                            <p className="text-gold-600 uppercase text-[9px] tracking-widest mb-1 font-bold">Date & Time</p>
                            <p className="font-bold text-white text-lg font-serif tracking-wide">DEC 24, 2025</p>
                            <p className="text-slate-400 text-xs tracking-wider">7:00 PM - LATE</p>
                        </div>
                        <div className="text-left">
                            <p className="text-gold-600 uppercase text-[9px] tracking-widest mb-1 font-bold">Location</p>
                            <p className="font-bold text-white text-base leading-tight font-serif">
                                KUNDASANG CABIN,<br/>SABAH
                            </p>
                        </div>
                    </div>
        ...
        {/* Static Cut Line */}
        <div 
            className="relative z-30 flex items-center justify-center h-auto w-8"
        >
            <div className="absolute border-dashed border-white/30 h-full border-l-2 left-1/2 top-0"></div>
            <div className="absolute bg-slate-900 border border-gold-500/50 rounded-full z-10 w-5 h-5 -top-2.5 left-1/2 -translate-x-1/2"></div>
            <div className="absolute bg-slate-900 border border-gold-500/50 rounded-full z-10 w-5 h-5 -bottom-2.5 left-1/2 -translate-x-1/2"></div>
            <div className="absolute z-40 bg-gold-500 text-slate-900 rounded-full flex items-center justify-center font-bold text-lg w-9 h-9 -translate-x-1/2 left-1/2 top-0">
        ...
        {/* Static Stub */}
        <div 
            className="relative bg-gold-500 flex-shrink-0 flex items-center justify-center overflow-hidden border-2 border-gold-600 w-44 rounded-r-3xl border-l-0"
        >
            <div className="relative z-10 flex flex-col h-full w-full p-6 justify-between items-center">
                <div className="flex-grow w-full flex items-center justify-center py-4">
                     <Barcode vertical={true} color="bg-slate-900" className="w-full h-full opacity-80 mix-blend-multiply" />
                </div>
                <div className="mt-1 text-center">
                    <span className="font-mono text-slate-900 font-bold text-sm tracking-[0.2em]">
                        NO. 082492
                    </span>
                </div>
            </div>
      ...
      {/* ACTION BUTTONS (Save & Google Form) */}
      <div className={`flex flex-col items-center gap-4 transition-all duration-700 ease-in-out z-50 ${isTorn ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10 pointer-events-none'}`}>
        {/* SAVE BUTTON */}
        <button
        ...
        <a 
          ...
          className="
            ...
            text-white font-serif tracking-widest text-xs md:text-sm font-bold
